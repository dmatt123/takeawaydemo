...
<span class="postcodeInput_text">Check if we deliver to your area <span style="font-size: 8px;"><br>(use postcode DD1 1AA)</span></span> <input id="inputBoxPostcode" placeholder="ENTER YOUR POSTCODE"/></div>
